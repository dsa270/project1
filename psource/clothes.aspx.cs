    ...
    public partial class WebForm4 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(IGTMAIN.CS))
            {
                ...
                _innerhtml = "<a style =\"color: black;padding-top:5px; padding-bottom:0px;padding-left:10px;line-height:140%; line-height:140%;font-size:24px; font-weight: bold;\" href=\"#\">MEN</a> <hr style=\"height: 0;	margin-top: 0;	margin-bottom: 5px;	border: 0;	border-top: 5px solid #000000;;\"/>";
                string cmdText = "SELECT TOP 8  * FROM product where product_status='ACTIVE' and product_Sub_category_code ='MEN'  order by  product_id DESC";
            ...
            using (SqlConnection con = new SqlConnection(IGTMAIN.CS))
            {
                ...
                _innerhtml = "<a style =\"color: black;padding-top:5px; padding-bottom:0px;padding-left:10px;line-height:140%; line-height:140%;font-size:24px; font-weight: bold;\" href=\"#\">WOMEN</a> <hr style=\"height: 0;	margin-top: 0;	margin-bottom: 5px;	border: 0;	border-top: 5px solid #000000;;\"/>";
                string cmdText = "SELECT TOP 8  * FROM product where product_status='ACTIVE' and product_Sub_category_code ='WOMEN'  order by  product_id DESC";
            ...
            using (SqlConnection con = new SqlConnection(IGTMAIN.CS))
            {
                ...
                _innerhtml = "<a style =\"color: black;padding-top:5px; padding-bottom:0px;padding-left:10px;line-height:140%; line-height:140%;font-size:24px; font-weight: bold;\" href=\"#\">KIDS</a> <hr style=\"height: 0;	margin-top: 0;	margin-bottom: 5px;	border: 0;	border-top: 5px solid #000000;;\"/>";
                string cmdText = "SELECT TOP 8  * FROM product where product_status='ACTIVE' and product_Sub_category_code ='KIDS'  order by  product_id DESC";
