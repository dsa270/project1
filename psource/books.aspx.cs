    ...
    public partial class WebForm5 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(IGTMAIN.CS))
            {
                ...
                _innerhtml = "<a style =\"color: black;padding-top:5px; padding-bottom:0px;padding-left:10px;line-height:140%; line-height:140%;font-size:24px; font-weight: bold;\" href=\"#\">STORY BOOK</a> <hr style=\"height: 0;	margin-top: 0;	margin-bottom: 5px;	border: 0;	border-top: 5px solid #000000;;\"/>";
                string cmdText = "SELECT TOP 8  * FROM product where product_status='ACTIVE' and product_Sub_category_code='STORY BOOK'  order by  product_id DESC";
            ...
            using (SqlConnection con = new SqlConnection(IGTMAIN.CS))
            {
                ...
                _innerhtml = "<a style =\"color: black;padding-top:5px; padding-bottom:0px;padding-left:10px;line-height:140%; line-height:140%;font-size:24px; font-weight: bold;\" href=\"#\">REFERENCE BOOK</a> <hr style=\"height: 0;	margin-top: 0;	margin-bottom: 5px;	border: 0;	border-top: 5px solid #000000;;\"/>";
                string cmdText = "SELECT TOP 8  * FROM product where product_status='ACTIVE' and product_Sub_category_code='REFERENCE BOOK'  order by  product_id DESC";
                ...
                if (dr.HasRows)
                {
                    ...
                    while (dr.Read())
                    {
                        ...
                        _innerhtml = _innerhtml + "<div class=\"col-sm-3\" style=\"line-height:140%;max-height:100px; max-height: 400px; min-height:400px;max-width100%;border: 5px solid white; background-color:white;\"> <div style=\"vertical-align:top; margin-top:0px; \"> <a href=\"" + dr["product_code"].ToString() + ".aspx\" title =\"" + dr["product_code"].ToString() + "\" target=\"_blank\"> <img src=\"pimages/" + ImageName + "\"CssClass=\"img-responsive\" style =\"max-width:300px; max-height:250px; text-align:center;vertical-align:top; \" alt=\"" + dr["product_name"].ToString() + "\"> <br/>  <h4 style=\"color:black; line-height:140%;font-size:16px; font-weight: bold;font-family: \"Mangal\"; display:inline-block; padding:0px; left-padding:5px;\"> " + dr["product_name"].ToString() + " </h4> </a></div> </div>";
                    }
                }

                REFERENCE.InnerHtml = _innerhtml;
            }
            //END OF ELECTRONICS
            ...
            using (SqlConnection con = new SqlConnection(IGTMAIN.CS))
            {
                ...
                _innerhtml = "<a style =\"color: black;padding-top:5px; padding-bottom:0px;padding-left:10px;line-height:140%; line-height:140%;font-size:24px; font-weight: bold;\" href=\"#\">QUESTION BANK</a> <hr style=\"height: 0;	margin-top: 0;	margin-bottom: 5px;	border: 0;	border-top: 5px solid #000000;;\"/>";
                string cmdText = "SELECT TOP 8  * FROM product where product_status='ACTIVE' and product_Sub_category_code='STORY QUESTION BANK'  order by  product_id DESC";
