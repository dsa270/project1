<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Datewise_Visit_Report.aspx.cs" Inherits="IGTNewsfNation.Datewise_Visit_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <div   style="background-color:#f2f2f2; min-height:500px;">
         ...
         <div class="col-sm-12" style="background-color:#f2f2f2;text-align:center;margin:auto;">
