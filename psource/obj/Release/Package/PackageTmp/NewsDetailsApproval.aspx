<%@ Page validateRequest="false" Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="NewsDetailsApproval.aspx.cs" Inherits="IGTNewsfNation.NewsDetailsApproval" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-sm-12"  style="background-color: #0f3955; color:white; line-height:140%;font-size:20px; font-family:Cambria; " >
                     Home>News Details Approval - Final (on Submit with Active Status show to live Website)
    </div>
        ...
        <div class="col-sm-12" style="text-align:left;padding:10px;">
             ...
             <div class="col-sm-3" style="text-align:left; padding-left:5px;" >
                     <asp:DropDownList ID="ddl_News_Type" Width="100%" Height="25px" runat="server" OnSelectedIndexChanged="ddl_News_Type_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                </div>
            <div class="col-sm-1" style="text-align:right; vertical-align:central">  
                News Code: 
                    </div>
            <div class="col-sm-7" style="text-align:left; padding-left:5px;" >
                 <asp:DropDownList ID="ddl_News_Code" Width="100%" Height="25px" runat="server" OnSelectedIndexChanged="ddl_News_Code_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
               ...
               <div class="col-sm-12" style="text-align:left;padding:10px;">
                ...
                Title:
                  ...
                  <asp:TextBox style ="text-transform:uppercase; padding-left:10px"   ID="txt_Title" runat="server" Width="100%" AutoPostBack="true" MaxLength="100" ></asp:TextBox>
               </div>
                          </div>
         ...
         <div class="col-sm-12" style="text-align:left;padding:10px;">
              ...
              English  Title:
                  ...
                  <asp:TextBox style ="text-transform:uppercase; padding-left:10px"   ID="txt_ETitle" runat="server" Width="100%" AutoPostBack="true" OnTextChanged="txt_ETitle_TextChanged" MaxLength="90" ></asp:TextBox>
          ...
          <div class="col-sm-12" style="text-align:left;padding:10px;">
              ...
              Introduction:
                  ...
                  <asp:TextBox style ="text-transform:uppercase; padding-left:10px"   ID="txt_Intro" runat="server" Width="100%" MaxLength="160"  ></asp:TextBox>                                            
               </div>
                          </div>
           <div class="col-sm-12" style="text-align:left;padding:10px;">
                 <div class="col-sm-1" style="text-align:right; vertical-align:central">  
          ...
          <div class="col-sm-12" style="text-align:left;padding:10px;">
            ...
            <div class="col-sm-3" style="text-align:left; padding-left:5px;" >
                    ...
                    <asp:DropDownList AutoPostBack="true" ID="ddl_State" Width="100%" Height="25px" runat="server" OnSelectedIndexChanged="ddl_State_SelectedIndexChanged"></asp:DropDownList>
                </div>
          ...
          <div class="col-sm-1" style="text-align:right; vertical-align:central">  
            ...
            <div class="col-sm-1" style="text-align:left; padding-left:5px;" >
                    ...
                    <asp:DropDownList ID="ddl_Priority" Width="100%" Height="25px" runat="server"></asp:DropDownList>
                </div>
